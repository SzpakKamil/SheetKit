...
class SKTPickerComponentView: UIView {
    ...
    weak var delegate: SKTPickerComponentViewDelegate?

    var style: SKTPickerViewStyle = .default {
        didSet {
            setupStyle()
        }
    }
    ...
    private func setupTableView() {
        ...
        tableView.register(SKTPickerComponentViewCell.self, forCellReuseIdentifier: SKTPickerComponentViewCell.reuseIdentifier)
    ...
    private func updateVisibleCellsMask() {
        ...
        tableView.visibleCells.forEach { cell in
            (cell as? SKTPickerComponentViewCell)?.maskLabel(with: middleRect)
        }
    }
...
extension SKTPickerComponentView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: SKTPickerComponentViewCell.reuseIdentifier, for: indexPath)
        if let cell = cell as? SKTPickerComponentViewCell, let delegate {
            cell.configure(
